...
<div class="confirmation-page"
	...
	<h1>Add Position Confirmation</h1>

	<h4>
		You have successfully added the position <b>${position.jobTitle}</b>
	</h4>
	...
	<div class="confirmation-data">
		...
		<div class="confirmation-button-container">
			...
			<a href="${addPositionURL}"><button
					class="confirmation-button-style" type="button">Add
